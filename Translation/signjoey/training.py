...
class TrainManager:
    ...
    def __init__(self, model: SignModel, config: dict) -> None:
        ...
        # self.use_cuda = train_config["use_gpu"]
        
        # if self.use_cuda:
        #     self.model.cpu()
        #     if self.do_translation:
        #         self.translation_loss_function.cpu()
        #     if self.do_recognition:
        #         self.recognition_loss_function.cpu()
    ...
    def init_from_checkpoint(
        ...
        """
        model_checkpoint = load_checkpoint(path=path, use_cuda=False)
